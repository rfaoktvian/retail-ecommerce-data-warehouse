  ...
  create or replace view `qwiklabs-gcp-04-05c5517686d1`.`silver`.`csv_geolocation`
  OPTIONS()
  as -- Silver: geolocation
...
from `qwiklabs-gcp-04-05c5517686d1`.`bronze`.`csv_geolocation`
